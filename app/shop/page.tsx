...
export default function ShopPage() {
  return <>
    ...
    <section className="section"><div className="shell"><div className="collection-grid collection-grid--shop">{collections.map((collection) => <CollectionCard key={collection.slug} collection={collection} />)}</div></div></section>
