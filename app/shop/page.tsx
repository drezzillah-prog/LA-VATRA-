...
export default function ShopPage() {
  return <>
    ...
    <section className="section shop-house-section"><div className="shell"><div className="section-heading"><p className="eyebrow">Odaile casei</p><h2>Intră prin casă.</h2></div><HouseRooms compact /></div></section>
